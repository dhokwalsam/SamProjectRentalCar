...
function XOnstart() {
    ...
    for (var i = 1; i <= 2; i++) {
        ...
        if (IsDate(sDateTime)) {
            ...
            // AND some JavaScript date functions need conversion to US format to work
            ...
            sDateUnitedStatesFormat = sDateOnlyArray[1] + "/" + sDateOnlyArray[0] + "/" + sDateOnlyArray[2] + " " + sDateSpaceArray[1];
            //Allow for AM and PM
            if (sDateSpaceArray.length > 2) sDateUnitedStatesFormat += " " + sDateSpaceArray[2];
            var d = new Date(sDateUnitedStatesFormat);
